...
const styles = {
    global: (props)=>({
            body: {
                bg: (0,_chakra_ui_theme_tools__WEBPACK_IMPORTED_MODULE_1__.mode)("#da1b60", "#0a3239")(props) // left is day mode, right is night mode
            }
        })
};
const components = {
    ...
    Link: {
        baseStyle: (props)=>({
                color: (0,_chakra_ui_theme_tools__WEBPACK_IMPORTED_MODULE_1__.mode)("#5fc89d", "#ff8a00")(props),
